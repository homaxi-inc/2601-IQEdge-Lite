...
| [`docs/deliveries/DELIVERY_M4.md`](docs/deliveries/DELIVERY_M4.md) | M4 energy Ingest |
| [`docs/verification/README.md`](docs/verification/README.md) | **AWS 控制台验收证据** — 逐步录入 |
