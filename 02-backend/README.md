...
| [`docs/G2_Implementation_Task_Breakdown.md`](../../04-cloud/docs/G2_Implementation_Task_Breakdown.md) | **任务分解** — 索引 → `04-cloud/docs/` 完整版 |
...
| [`09-contract/`](../09-contract/) | OpenAPI / JSON Schema（M0.2 ✅） |
